...
## Project Structure
    ...
    ├── testapiautosetting_125060  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125060`
...
2. Clone this repo and `cd testapiautosetting_125060`
